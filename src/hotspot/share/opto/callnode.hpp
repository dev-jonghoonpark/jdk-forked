...
public:
  ...
  // Boxing macro nodes may lack a safepoint on the fast path.
  // Once expanded (no longer macro), they are guaranteed safepoints.
  virtual bool        guaranteed_safepoint()  { return !(is_boxing_method() && is_macro()); }
