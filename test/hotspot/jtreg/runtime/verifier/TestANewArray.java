...
public class TestANewArray {
    ...
    public static void main(String... args) throws Exception {
        ...
        ProcessBuilder pb = ProcessTools.createTestJavaProcessBuilder("-Duser.language=en", "-Xverify:all", "-cp", ".",  classCName);
        ...
        pb = ProcessTools.createTestJavaProcessBuilder("-Duser.language=en", "-Xverify:all", "-cp", ".",  classCName);
